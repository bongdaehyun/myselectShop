...
class ProductServiceTest {
    ...
    void test1() {
        // given
        Long productId = 100L;
        int myprice = ProductService.MIN_MY_PRICE +300_000;
        ...
        //when
        ProductResponseDto result = productService.updateProduct(productId, productMypriceRequestDto);
    ...
    void test2() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class,
                () -> productService.updateProduct(productId,productMypriceRequestDto));
        // then
        assertEquals("유효하지 않은 관심 가격입니다. 최소 " + ProductService.MIN_MY_PRICE + "이상 설정해주십시요.",exception.getMessage());
    }
}